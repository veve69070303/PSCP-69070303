...
```text
รับ input มาเก้บใน word ละเอามาเก้บใน a ละเอามากลับด้วย บวก ใส่  lower ให้เป็นตัวเล็กทั้งหมด ละก้ print
```
...
```text
1 รับ ค่า 2 เอา ค่ามาใส่ในตัวแปร 3  เอามากลับด้าน และ ทำให้เป็นตัวเล็ก 4 print
```
...
```text
ใช่ ทำตามแผน เพราะลองทำแล้วมันผ่าน
```
