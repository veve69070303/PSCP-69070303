...
```text
รับค่ามาสองค่า ค่าแรกคือ เลขที่หวยจะออก อันที่สองคือเลขที่เราซื้อมา ละก้ไปทำตาเงือนไขเลข ถ้า ตัวอักษรถุกก้คูรไป10 แต่ถ้าตัวอักษรถุกแต่เลขไม่ถุกเลย ก้ได้20 เลขท้ายสองตัวได้100 สามตัวได้ 200 ละก้ปริ้นเลขออกมา
```
