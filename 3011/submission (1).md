...
```text
รับ  input มาเป็นตัวใหญ่แค่ตัวแรก นำ อินผุด หรือ สีมา บวกกัน เช็ค ถ้าเป็น สีเดียวกัน ให้ใส่สีเดิม ถ้าเป็นสีอื่นนอกเหนือจากแม่สี ให้ print error และก้ ผสม 3 สีตามที่โจทย์ต้องการ
```
...
```text
1  รับค่า 2 เอาสีมาบวกกัน 3 เช็ค ตัวแปรสีต่างๆ ว่าถุกต้องมั้ย 4 print
```
...
```text
ใช้เหมือนที่วางแผนไว้เลยเพราะมันทำแล้ว pass
```
...
```text
เพราะมันเป็นสีที่ไม่ยุใน แม่สี
```
...
```text
เพราะมันเปนตัวเล็ก และไม่ยุใรแม่สี
```
