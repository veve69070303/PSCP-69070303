...
```text
รับ input มาเช็คว่า vat อยู่ในช่วงไหน ถ้าเงินอยู่ระหว่าง 0 ถึง 500 sc == 50 ระหว่าง 500  ถึง 10000 ให้ sc * 0.1 ถ้ามากวก่า 10000  sc == 1000 นำ sc บาบวก ราคา เต็ม และ * 1.07 และ ทำให้เป็น ทศนิยม สองตำแหน่ง และ print
```
...
```text
1 รับ input มาเช็คว่า vat อยู่ในช่วงไหน 2 ดูเงินว่ายุในช่วงไหน 3 นำ sc บาบวก ราคา เต็ม และ * 1.07 และ 4ทำให้เป็น ทศนิยม สองตำแหน่ง และ print
```
