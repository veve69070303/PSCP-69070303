...
```text
อย่างแรกก็รับอินพุตมาเป็นseason กับ day เอามาใส่if ถ้าเป็น 123 ตอบเปน Winter ละ ถ้าวัน เดือนที่3 และ dayมากว่า 21  ให้ เปลียนเป็น spring  ก้ทำแบบนี้ 3 เดือนเปลัยน ไปเรื่อยๆ
```
...
```text
1อย่างแรกก็รับอินพุตมาเป็นseason กับ day 2เอามาใส่if ถ้าเป็น 123 ตอบเปน Winter ละ ถ้าวัน เดือนที่3 และ dayมากว่า 21  ให้ เปลียนเป็น spring  ก้ทำแบบนี้ 3 เดือนเปลัยน ไปเรื่อยๆ
```
