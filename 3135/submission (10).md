...
```text
รับค่ามาสามอันnkt ถ้า t เปนหนึ่งให้ตอบ1 ถ้าไม่ใข่ ให้ไปหาต่อ while true nextt = สูตร หา ว่าตอนนี่อยู่คนที่เท่าไร ถ้าถึฝคนที่1 ให้break หรือ เท่ากับโจรหรือคนที่t ให้break ละก้ให้ kon เปลียนเปน nextt ปละหาต่อจนกว่าจะเจอ1 หรือ T ปริ้นว่าเปลียนมือไปกี่รอบ
```
